...
async function testrefundquery(){
    const refund=await pay.refundquery({
        out_refund_no:'20139999'
    });
    console.log('refund',refund);
}
...
async function testdownloadbill(){
    const refunds=await pay.downloadbill({
        bill_date:'20190708',
        bill_type:'ALL'
    });
    console.log(refunds);
